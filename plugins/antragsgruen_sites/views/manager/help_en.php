...
$this->title = 'Antragsrot - The Online Motion Administration';
...
<div class="content managerHelpPage">
    ...
    <h2 id="basic_structure">Basic structure of an Antragsrot-Site</h2>

    <h3 id="motions">Motions / Amendments</h3>
    <p>“Motion” refers to all kind of documents published on Antragsrot. Originally, the system was primarily developed
    ...
    <p>“Amendment” refers to special documents that aim to alter an existing motion by specifying how the motion is
        supposed to look after applying the amendment. Antragsrot specifically aims to ease the handling of lots of
    ...
    <p>Each installation of Antragsrot has at least one such consultation, but can have an arbitrary number as such.
    ...
    <p>To enable this kind of flexibility, Antragsrot uses the concept of motion types. An arbitrary number of motion
    ...
    <p>Setting up an agenda for a consultation is a purely optional feature of Antragsrot and targets assemblies and
        conventions.</p>
    ...
    <p>Different organizations have different requirements for their members to submit motions of amendments.
        Antragsrot tries to cover as many of those needs as possible:</p>
    <ul>
    ...
    <p>It is possible to restrict functions like submitting motions or amendments, or supporting or commenting on them
        to registered users. Antragsrot’s registration process is designed to support different kinds of login
        mechanisms.</p>
    ...
    <p>If Antragsrot is supposed to leverage an existing Single-Sign-On-Solution, it is possible to include other log
        in mechanisms. For example, Antragsrot has been successfully deployed in environments providing OpenID- and
        SAML-based SSO. If you are interested in that topic, please contact us.</p>

    <h3 id="deadlines">Deadlines</h3>

    <p>Antragsrot supports setting a deadline for submitting motions and amendments. This can be done individually for
    ...
    <p>Antragsrot offers many ways to stay up date on what’s happening on a consultation by e-mail-notifications.</p>
    ...
    <p>Antragsrot offers several ways of adopting changes requested by amendments into the corresponding motion. You
    ...
    <p>However, in this view, conflicts between amendments may occur as well, if they propose to change the same passage
        of text in an incompatible way. Antragsrot tries to display as many changes as possible inline, but if that’s
    ...
    <p>After creating the new motion text, it is important to set the new statuses of the amendments (accepted,
        ...
        functional impact on Antragsrot, this is helpful for users to get a quick overview over what amendments have
    ...
    <p>Several PDF templates with different appearances are provided, covering different use cases. Which template to
        ...
        installations of Antragsrot render PDFs using a rather simple PDF-generator, but for improved typography, PDF
    ...
    <p>In some editorial meetings, a tabular overview of all submitted amendments is required to efficiently discuss all
        amendments with the proposers of the original motion. Antragsrot is able to create such a document
    ...
    <p>Several organizations using Antragsrot to prepare all motions and amendments are using OpenSlides to as a
        presentation system for their assemblies. Therefore, Antragsrot also supports a CSV-Export that is specifically
    ...
    <p>Different aspects of the layout of Antragsrot can be changed from the web interface – most of them at “Settings”
    ...
    <p>Every published motion and amendment is assigned a unique code or signature, like “M1” for motion no. 1, “AM1”
        for amendment no. 1, or “M1-007” for an amendment affecting motion “M1” at line 7. Antragsrot supports
    ...
    <p>Antragsrot supports three ways of change and internationalize the user interface and the wording:</p>
    <ul>
        ...
        <li>Translation Antragsrot: It is possible to translate Antragsrot into another language – currently, we
            provide translations into english, german and french. However, this is not possible using the web interface
            and needs some changes to the source code. If you are interested in translating Antragsrot into a language
